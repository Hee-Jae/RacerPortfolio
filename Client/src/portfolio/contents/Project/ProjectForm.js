...
const ProjectForm = (props) => {
  ...
  const [project, setProject] = useState(props.projectData.filter(item => (item.id === props.formId))[0].name);
  const [description, setDescription] = useState(props.projectData.filter(item => (item.id === props.formId))[0].description);
  const [startdate, setStartdate] = useState(props.projectData.filter(item => (item.id === props.formId))[0].startdate);
  const [enddate, setEnddate] = useState(props.projectData.filter(item => (item.id === props.formId))[0].enddate);
  const [url, setUrl] = useState(props.projectData.filter(item => (item.id === props.formId))[0].url);
  ...
  const deleteHandler = () => {
    ...
    const newProjectData = props.projectData.filter(item => item.id !== props.formId);
