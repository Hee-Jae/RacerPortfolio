...
export const eduDataValidation = (eduData) => {
  ...
  eduData.forEach(element => {
    if(element.name === '' || element.major === '' || element.edu_type === ''){
      result = false;
      return;
    }
  });
...
export const projectDataValidation = (projectData) => {
  ...
  projectData.forEach(element => {
    if(element.name === '' || element.description === '' || element.startdate === '' || element.enddate === '' || element.url === ''){
      result = false;
      return;
    }
  });
